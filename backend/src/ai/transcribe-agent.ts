...
export class TranscribeAgent extends EventEmitter{
    ...
    constructor(config: TranscribeAgentConfig) {
        ...
        this.#llm = new ChatGoogleGenerativeAI(this.#config.chatGoogleGenerativeAI());
        ...
        this.#speech = new SpeechClient(this.#config.speechClient());
    ...
    on(event: "stream:open", listener: (stream: ReturnType<ImprovedStreamingClient["streamingRecognize"]>, meta:TranscribeEventMetadata) => void): this;
    on(event: "stream:close", listener: (stream: ReturnType<ImprovedStreamingClient["streamingRecognize"]>, meta:TranscribeEventMetadata) => void): this;
    on(event: "stream:queue#unsafe", listener: (meta:TranscribeEventMetadata) => void): this;
    on(event: "stream:send", listener: (stream: ReturnType<ImprovedStreamingClient["streamingRecognize"]>, data: Buffer, meta:TranscribeEventMetadata) => void): this;
    on(event: "stream:done", listener: (meta:TranscribeEventMetadata) => void): this;
